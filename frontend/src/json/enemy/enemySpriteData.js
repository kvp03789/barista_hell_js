...
{   Slime: {
        ...
        "frameTags": [
            ...
            { "name": "death", "from": 46, "to": 55, "direction": "forward", "repeat": "1", "color": "#000000ff" },
            { "name": "spawn", "from": 56, "to": 66, "direction": "forward", "repeat": "1", "color": "#000000ff" }
        ],
        "layers": [
            { "name": "slime base" },
            { "name": "Layer 1", "group": "slime base", "opacity": 255, "blendMode": "normal" },
            { "name": "atack vfx", "group": "slime base", "opacity": 255, "blendMode": "normal" },
            { "name": "slime regrup", "opacity": 255, "blendMode": "normal" },
            { "name": "Layer 7", "opacity": 255, "blendMode": "normal" },
            { "name": "death fx", "opacity": 255, "blendMode": "normal" }
        ],
        "slices": [
        ]
        },
        ...
        generateAnimations(spritesheetAsset) {
            ...
            for(let i = tag.from; i <= tag.to; i++){
                this.animations[tag.name].push(`slime_enemy_${i}.png`)
            }
            })
        }
    }
